...
func (e endpointForm) View() templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2, templ_7745c5c3_Err = templ.JoinStringErrs(fmt.Sprintf("/register/%s", models.UserFromCtx(ctx).ApiKey.String()))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/pages/endpointForm.templ`, Line: 23, Col: 152}
		}
		...
		var templ_7745c5c3_Var3 templ.SafeURL = templ.URL(fmt.Sprintf("/register/%s", models.UserFromCtx(ctx).ApiKey.String()))
